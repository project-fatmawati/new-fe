...
function ListEvent() {
  const handleClick = () => {
    alert('Maaf, Event belum tersedia. Silakan coba lagi nanti.');
  };
  return (
    <div className="py-[300px] text-center justify-center">
        ...
        <button className="bg-cyan p-2 border rounded-md cursor-pointer hover:bg-teal font-medium text-xl" onClick ={handleClick}>JOIN EVENT</button>
