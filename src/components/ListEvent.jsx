...
function ListEvent() {
  return (
    <div className="py-[100px] text-center justify-center">
        ...
        <button className="bg-cyan p-2 border rounded-md cursor-pointer hover:bg-teal font-medium text-xl">JOIN EVENT</button>
